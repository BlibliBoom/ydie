    ...
    var _o,
        ...
        Lt = function () {
            ...
            return t.prototype.subscribePaperBaseInfoChanged = function (t) {
                ...
                this.target = $('<div class="hiprint-printPaper"><div class="hiprint-printPaper-content"></div></div>'), this.paperContentTarget = this.target.find(".hiprint-printPaper-content"), this.target.css("width", this.mmwidth + "mm"), this.target.css("height", this.mmheight), this.target.attr("original-height", this.mmheight);//this.mmheight - .4 + "mm"
